...
- Example Code:
  ...
  --double-id \
  --threads 1 \
  --score JointPRS_tune_${pop1}_${pop2}_${pop3}_${pop4}_${r1}${r2}${r3}${r4}_${type}_${target_pop}_pst_eff_a1_b0.5_phi${param_phi}_chr${chr}.txt 2 4 6 \
  --out ${trait}_${pop1}_${pop2}_${pop3}_${pop4}_${type}_JointPRS_tune_${target_pop}_phi${param_phi}_chr${chr}
  ```
