...
We use the reference panel from [PRScsx](https://github.com/getian107/PRScsx#getting-started) and you can download the reference data [here](https://personal.broadinstitute.org/hhuang/public/PRS-CSx/Reference/).
