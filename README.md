...
# JointPRS
JointPRS is a multi-population PRS model that only requires GWAS summary statistics and LD reference panels from multiple populations. When individual-level tuning data is available, it adopts a data-adaptive approach combining meta-analysis and tuning strategies. This framework is described in detail in:
...
<p align="center">
  <img src="[https://github.com/user-attachments/files/20256268/Figure1.pdf](https://github.com/user-attachments/files/20256569/Figure1.pdf)" alt="JointPRS Workflow"/>
</p>

## Comprehensive JointPRS Pipelines

Below is an overview of different usage scenarios with links to both pipeline and evaluation scripts. For full details, see the [JointPRS_analysis repository](https://github.com/LeqiXu/JointPRS_analysis).

| **Scenario & Description**                                                                                                                                       | **Pipeline Scripts**                                                                                                                                                                                                                                                                                                                                                                                       | **Evaluation Scripts**                                                                                                                                                                                                                                                                                                                                                   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **1. No Tuning Data** *(JointPRS-auto)*<br/>- Directly derived from GWAS summary statistics, no tuning set required.                                             | - [GLGC](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/1.%20no_val/1.1%20GLGC.PRS5.JointPRS-auto.sh)<br/>- [PAGE](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/1.%20no_val/2.1%20PAGE.PRS3.JointPRS-auto.sh)<br/>- [BBJ](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/1.%20no_val/3.1%20BBJ.PRS2.JointPRS-auto.sh)<br/>- [Binary](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/1.%20no_val/4.1%20Binary.PRS2or3.JointPRS-auto.sh) | - [R² Evaluation](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/4.%20Method_evaluate/1.%20no_val/1.1%20no_val.PRS.r2.sh)<br/>- [AUC Evaluation](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/4.%20Method_evaluate/1.%20no_val/1.2%20no_val.PRS.auc.sh)                                                                                           |
| **2. Same-Cohort Tuning & Testing** *(JointPRS)*<br/>- One cohort split into tuning and test sets.                                                              | - [GLGC](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/2.%20same_cohort/1.1%20GLGC.PRS5.JointPRS.sh)<br/>- [PAGE](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/2.%20same_cohort/2.1%20PAGE.PRS3.JointPRS.sh)<br/>- [BBJ](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/2.%20same_cohort/3.1%20BBJ.PRS2.JointPRS.sh)<br/>- [Binary](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/2.%20same_cohort/4.1%20Binary.PRS2or3.JointPRS.sh) | - [R² Evaluation](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/4.%20Method_evaluate/2.%20same_cohort/2.1%20same_cohort.PRS_update.r2.sh)<br/>- [AUC Evaluation](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/4.%20Method_evaluate/2.%20same_cohort/2.2%20same_cohort.PRS_update.auc.sh)                                                  |
| **3. Different-Cohort Tuning & Testing** *(JointPRS)*<br/>- Tuning done in one cohort, testing in another.                                                      | - [GLGC](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/3.%20diff_cohort/1.1%20GLGC.PRS5.JointPRS.sh)<br/>- [PAGE](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/2.%20Method_calculate/3.%20diff_cohort/2.1%20PAGE.PRS3.JointPRS.sh)                                                                                                                   | - [R² Evaluation](https://github.com/LeqiXu/JointPRS_analysis/blob/main/Real_data/4.%20Method_evaluate/3.%20diff_cohort/3.1%20diff_cohort.PRS.r2.sh)                               |
